...
public class ControllerImpl implements Controller {
    ...
    public String addArea(String areaType, String areaName) {
        ...
        return String.format(
                ConstantMessages.SUCCESSFULLY_ADDED_AREA_TYPE,
                areaType
        );
    }
    ...
    public String buyFood(String foodType) {
        ...
        return String.format(
                ConstantMessages.SUCCESSFULLY_ADDED_FOOD_TYPE,
                foodType
        );
    }
    ...
    public String foodForArea(String areaName, String foodType) {
        ...
        if (food == null) {
            throw new IllegalArgumentException(String.format(
                    ExceptionMessages.NO_FOOD_FOUND,
                    foodType
            ));
        }
        ...
        return String.format(
                ConstantMessages.SUCCESSFULLY_ADDED_FOOD_IN_AREA,
                foodType, areaName
        );
    }
    ...
    public String addAnimal(String areaName, String animalType, String animalName, String kind, double price) {
        ...
        if (areaAndAnimalAreWaterBased || areaAndAnimalAreLandBased) {
            ...
            message = String.format(
                ConstantMessages.SUCCESSFULLY_ADDED_ANIMAL_IN_AREA,
                animalType, areaName
            );
        } else {
            message = ConstantMessages.AREA_NOT_SUITABLE;
        }
    ...
    public String calculateKg(String areaName) {
        Collection<Animal> animals = this.areas.get(areaName).getAnimals();

        double totalKilograms = animals.stream()
                .mapToDouble(Animal::getKg)
                .sum();

        return String.format(
                ConstantMessages.KILOGRAMS_AREA,
                areaName, totalKilograms
        );
    }
